...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " VIRAX" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " VIRAX" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " VIRAX");
    }
